...
namespace LEDBit {
	...
	let N1:number[] = [0x0, 0x8,0x10,0x8,0x30,0x8,0x50,0x8,0x90,0x9,0x10,0x0,0x10,0xc,0x10,0x8,0x10];
	...
	let W1:number[] = [0x0, 0x0,0x0,0x20,0x82,0x20,0x82,0x20,0x82,0x11,0x44,0x0,0x28,0x4,0x10,0x0,0x0];
